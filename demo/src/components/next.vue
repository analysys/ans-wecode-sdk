  ...
  <div>
    ...
    <el-card>
      <el-row>
        ...
        <el-col :span="24">
          <el-button type="primary" size="medium" @click="pageview"
            >pageview - 打开页面</el-button
          >
          <el-button type="primary" size="medium" @click="pageviewAndPageName"
            >pageview - 打开页面并添加别名</el-button
          >
          <el-button type="primary" size="medium" @click="pageviewAndProperty"
    ...
    <el-card>
      <el-row>
        ...
        <el-col :span="24">
          <el-button type="primary" size="medium" @click="track"
            >track - 统计事件</el-button
          >
          <el-button type="primary" size="medium" @click="trackAndProperty"
            >track - 统计事件并添加事件属性</el-button
          >
        </el-col>
      </el-row>
    </el-card>
    <el-card>
      <el-row>
        ...
        <el-col :span="24">
          <el-button type="primary" size="medium" @click="registerSuperProperty"
          ...
          >
          <el-button type="primary" size="medium" @click="clearSuperProperties"
            >clearSuperProperties - 清空通用属性</el-button
          >
          <el-button type="primary" size="medium" @click="getSuperProperty"
            >getSuperProperty - 获取单个通用属性</el-button
          >
          <el-button type="primary" size="medium" @click="getSuperProperties"
    ...
    <el-card>
      <el-row>
        ...
        <el-col :span="24">
          <el-button type="primary" size="medium" @click="alias"
            >alias - 用户ID与匿名ID关联</el-button
          >
          <el-button type="primary" size="medium" @click="identify"
            >identify - 匿名ID设置</el-button
          >
          <el-button type="primary" size="medium" @click="getDistinctId"
            >getDistinctId - 匿名ID获取</el-button
          >
        </el-col>
        <el-col :span="24">
    ...
    <el-card>
      <el-row>
        ...
        <el-col :span="24">
          <el-button type="primary" size="medium" @click="profileSetOnce"
            >profileSetOnce - 设置用户单个固有属性</el-button
          >
          <el-button type="primary" size="medium" @click="profileSetOnceMore"
            >profileSetOnce - 设置用户多个固有属性</el-button
          >
          <el-button type="primary" size="medium" @click="profileSet"
            >profileSet - 设置单个用户属性</el-button
          >
          <el-button type="primary" size="medium" @click="profileSetMore"
            >profileSet - 设置多个用户属性</el-button
          >
          <el-button type="primary" size="medium" @click="profileIncrement"
            >profileIncrement - 设置用户属性单个相对变化值</el-button
          >
          <el-button type="primary" size="medium" @click="profileIncrementMore"
            >profileIncrement - 设置用户属性多个相对变化值</el-button
          >
          <el-button type="primary" size="medium" @click="profileAppend"
            >profileAppend - 增加列表类型的属性</el-button
          >
          <el-button type="primary" size="medium" @click="profileUnset"
            >profileUnset - 删除单个设置的属性值</el-button
          >
          <el-button type="primary" size="medium" @click="profileDelete"
            >profileDelete - 删除所有设置的属性值</el-button
          >
        </el-col>
      </el-row>
    </el-card>
    ...
    <el-card>
      <el-row>
        ...
        <el-col :span="24">
          <el-button type="primary" size="reset" @click="reset"
            >reset - 清除本地设置</el-button
          >
        </el-col>
      </el-row>
    </el-card>
